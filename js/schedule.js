...
function simWeek(state) { const out = []; for (let i = 0; i < 6; i++) out.push(...simDay(state)); return out; }
function simMonth(state) { const out = []; for (let i = 0; i < 4; i++) out.push(...simWeek(state)); return out; }
